...
- **Detect Logged in user**: Detects if user is logged in or not - hides/shows admin functions in navbar depending on logged in status ( api key). All Admin interactions require the api key.
